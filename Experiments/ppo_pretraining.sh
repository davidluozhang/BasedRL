...
echo "===== ppo_pretrained, poacher survival reward, ranger first, short epochs, fast alternation, starting ====="
python ~/BasedRL/main.py --agent-id 1 --agent-learn "ppo" --epoch 100 --step-per-epoch 10000 --lr 5e-5 --logdir "ppo_pretrained/ranger"
python ~/BasedRL/main.py --agent-id 0 --agent-learn "ppo" --epoch 100 --step-per-epoch 10000 --lr 1e-5 --logdir "ppo_pretrained/poacher"
