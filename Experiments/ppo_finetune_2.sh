...
do
echo "===== Iteration $i ====="
python ~/BasedRL/main.py --agent-id 1 --agent-learn "ppo" --epoch 1 --step-per-epoch 1000 --lr 5e-2 --agent-opponent "ppo" --eps_clip .1 --recompute_advantage True --resume-path "ppo_fix_4/ranger/gsg/ppo/policy.pth" --opponent-path "ppo_fix_4/poacher/gsg/ppo/policy.pth" --logdir "ppo_fix_4/ranger" --iter $i --eps-train 0.15
echo "===== Training Poacher Now ====="
python ~/BasedRL/main.py --agent-id 0 --agent-learn "ppo" --epoch 1 --step-per-epoch 1000 --lr 5e-2 --agent-opponent "ppo" --eps_clip .1 --recompute_advantage True --resume-path "ppo_fix_4/poacher/gsg/ppo/policy.pth" --opponent-path "ppo_fix_4/ranger/gsg/ppo/policy.pth" --logdir "ppo_fix_4/poacher" --iter $i --eps-train 0.15
done
